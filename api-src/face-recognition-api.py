...
def detect_faces_in_image(file_stream):
    ...
    myurl = "https://s3-us-west-1.amazonaws.com/guardian-v1-storage/uploads/2f677114-e28e-4577-b044-d6029b67bb1c/Screen+Shot+2017-02-23+at+11.36.25+PM.jpg"
    myfile = urlopen(myurl)
    
    img = face_recognition.load_image_file(myfile)
